...
export const todoAppExplanation: string[] = [
  `This is the Todo List mini-app. It keeps track of a list of tasks that you can add to, delete and edit, storing them with React's useState hook and persisting them to localStorage so they aren't reset if you refresh the page.`,
...
export const moviesAppExplanation: string[] = [
  `This is the Movie Search mini-app. It demonstrates data fetching via an external API, in this case the TMDB movie database API.`,
...
export const storyAppExplanation: string[] = [
  `This is the Story Generator mini-app. It uses Huggingface's API to interact with a pre-trained AI model, in this case 'Mistral-7B-Instruct-v0.1'.`,
